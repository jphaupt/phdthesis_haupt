...
\hline
\multirow{3}{*}{$^3A_2$}
& \todo{}       & &    & \todo{}   & \red{value}\tnote{d} \\
& \todo{}       & &    & \todo{}   &  \\
& \todo{}       & &    & \todo{}   &  \\
\end{tabular}
\begin{tablenotes}
    \item[a] Experimental value, see references \parencite{loosMountaineering2018} \todo{}
    \item[b] Experimental value, see references \parencite{loos} \todo{}
    \item[c] Theoretical (\gls{EOM}-\gls{CCSD}) value, see references \parencite{bartlettAmmonia}\todo{}
