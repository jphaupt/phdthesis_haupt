...
Like \gls{FCI}, the wave function is expanded in some basis. Throughout this dissertation, Slater determinants are used, though \glspl{CSF} are also possible.\todo{cite Werner guga} The basis will be kept constant, and the coefficients may change with each time step,
\begin{equation}
