...
\end{equation}
i.e. the similarity-transforming operator $P=\e^J$.
...
\todo{now describe the form of $u$}

\todo{see Aron's paper to write out the original method}

\todo{...}

\todo{describe pseudoenergy and why we don't use it (HTC not Hermitian), then describe the variance and how we can derive self-consistent ways to derive HTC (refinement from Handy).}
