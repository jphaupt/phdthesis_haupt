...
Since F12 methods work directly on the wave function, it is also natural to extend to excited states, particularly for multireference methods.\todo{citations: see haettig} However, since the geminal terms include only occupied orbitals, there is an inherent bias to the ground state.\todo{citations} Several means of ameliorating this have been proposed,\todo{citations} including extending the geminal basis to include virtual orbitals.\todo{citations}
