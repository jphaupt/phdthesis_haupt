...
\todo{mention details about integration will be in the appendix}

For details pertaining to how we calculate the matrix elements and the associated \tchint library more generally, see appendix \ref{chap:pytchint}.
