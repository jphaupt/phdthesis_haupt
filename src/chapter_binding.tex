...
\begin{figure}[htbp]
    ...
    \caption{\todo{description of curves against experiment; mention they're fixed at 10 Bohr, except MRCI-F12 which didn't converge there; mention shaded = chemical accuracy -- also worth noting that the TC methods dip below experiment a little! but we are still variational; this is because we are comparing against the zeroed-at-10-bohr curve}}
...
\hline
\multirow{3}{*}{$^1\Pi_g$}
& non-TC exFCI & 345.8(0)  &  & \todo{} & \multirow{3}{*}{\todo{exp}} \\
& CASCI-xTC    & 341.86(4) &  & \todo{} &  \\
& CASSCF-xTC   & 340.729(3) &  & \todo{} &  \\
\hline
...
& CASSCF-xTC         & &    & \todo{}   &  \\
\bottomrule
\multicolumn{6}{l}{\small *In each row, the first two values are experimental, from references \todo{...} -- \todo{use threeparttable and tnote instead!}} \\
\multicolumn{6}{l}{\small and the last is last one is theoretical, from reference \todo{...}.}
\end{tabular}
