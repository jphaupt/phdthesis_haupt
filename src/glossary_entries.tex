...
\newacronym{DCD}{DCD}{distinguishable clusters with double excitations}
\newacronym{DCSD}{DCSD}{distinguishable clusters with single and double excitations}
\newacronym{2D}{2D}{two determinant}
\newacronym{DC-CCSDT}{DC-CCSDT}{distinguishable clusters with single, double and triple excitations}
...
\newacronym{FCIQMC}{FCIQMC}{full CI quantum Monte-Carlo}
