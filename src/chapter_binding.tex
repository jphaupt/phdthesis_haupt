...
\begin{itemize}
    ...
    \item The CASSCF-Jastrow \todo{...}
    \item The FCIQMC-Jastrow \todo{...}
\end{itemize}

\todo{mention the shifted minimum and Daniel's basic explanation (shift is about 2.8 mHa) - has to do with the orbitals or maybe because of the 1RDM, also mention how FCIQMC goes up a little (maybe because we capture less of the wave function?)}
