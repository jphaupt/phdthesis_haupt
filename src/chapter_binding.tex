...
\begin{figure}[htbp]
    ...
    \caption{\todo{description of curves against experiment; mention they're fixed at 10 Bohr, except MRCI-F12 which didn't converge there; mention shaded = chemical accuracy -- also worth noting that the TC methods dip below experiment a little! i.e. we are not fully variational(!)}}
