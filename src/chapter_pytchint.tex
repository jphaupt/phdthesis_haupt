...
\todo{mention GPU acceleration, Python libraries, JAX (+ AD?), deterministic optimisation with universal Jastrow factors, interfacing with other QMC libraries, more studies with solids, VMC python, det opt as a "fine tuning" of vmc jastrow ...}
