...
\begin{figure}[htbp]
    ...
    \label{eq:binding-universal-experiment}
\end{figure}
...
\begin{table}[htbp]
    ...
    \hline
    \multirow{3}{*}{N$_2$} & Non-TC & \todo{} & \todo{} & \todo{} & \todo{} \\
      & $ee+en$ & \todo{} & \todo{} & \todo{} & \todo{} \\
      & Atomic+$ee$-FCIQMC & \todo{} & \todo{} & \todo{} & \todo{} \\
    \hline
    \multirow{3}{*}{C$_2$} & Non-TC & \todo{} & \todo{} & \todo{} & \todo{} \\
    & $ee+en$ & \todo{} & \todo{} & \todo{} & \todo{} \\
    & Atomic+$ee$-FCIQMC & \todo{} & \todo{} & \todo{} & \todo{} \\
    \hline
    \multirow{3}{*}{O$_2$} & Non-TC & \todo{} & \todo{} & \todo{} & \todo{} \\
    & $ee+en$ & \todo{} & \todo{} & \todo{} & \todo{} \\
    & Atomic+$ee$-FCIQMC & \todo{} & \todo{} & \todo{} & \todo{} \\
    \hline
    \multirow{3}{*}{CN} & Non-TC & \todo{} & \todo{} & \todo{} & \todo{} \\
    & $ee+en$ & \todo{} & \todo{} & \todo{} & \todo{} \\
    & Atomic+$ee$-FCIQMC & \todo{} & \todo{} & \todo{} & \todo{} \\
    \end{tabular}
...
\todo{...}
\todo{ECPs with universal/atomic Jastrows}
