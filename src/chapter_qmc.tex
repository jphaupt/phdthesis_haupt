...
Controlling the stochastic error is critical in \gls{MC} methods. To estimate the reliability of our estimate, we can determined the standard deviation of the estimate. Our sampling scheme is a binomial distribution, with $p=\pi/4$. Hence,
\begin{equation}
