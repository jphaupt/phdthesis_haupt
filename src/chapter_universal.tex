...
We therefore introduce gaussian cutoff functions,\footnote{We have also tested the polynomial cutoff functions as used in the atomic Jastrows, but these were found to result in highly nonvariational energies.}
\begin{align}
